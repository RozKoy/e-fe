...
import { LoadingProvider } from "@/app/_providers/LoadingProvider";
...
const MENU_LIST: MenuListInterface[] = [
    ...
    },
    {
        ...
        title: "Usulan",
        permission: "Lihat Disposisi Proposal",
    },
    {
                        ...
                        <div className="h-full my-8 px-10 space-y-3 overflow-x-hidden overflow-y-auto">
                            {user?.role?.rolePermissions &&
                                MENU_LIST.map((menu, index) => {
                                    if (
                                        menu.permission &&
                                        !permissionCheck(user, menu.permission)
                                    ) {
                                        return null;
                                    }
                                    return (
